...
public class AddDate extends JFrame implements ActionListener{
	 ...
	 * @param args
	 */
	String[] inf = new String[]{"姓名","身份证号码","学号","性别","邮箱","手机号","院系"};
	JPanel panel;
	JTextField[] jt = new JTextField[7];
	//String[] tips = new String[]{"按本人有效证件填写","密码由6-16位英文字母、数字和特殊字符组成","请在填写一边密码，以辅助检验密码是否正确","请输入您的学号","","请认真核对您的证件号码","请设置一个安全邮箱，以便在忘记密码的时候找回密码","请输入11位手机号码",""};
	String[] data = new String[8];//存从文本框输入的内容
	...
	public void actionPerformed(ActionEvent e) {//
		// TODO Auto-generated method stub
		data[0] = "123456";//默认密码是123456
		for(int i=1;i<7;i++){//把从文本框输入的内容写入数组中
				data[i] = jt[i].getText();
		}
